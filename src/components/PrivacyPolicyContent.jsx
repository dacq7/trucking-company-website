  ...
  return (
    <article className="privacy-policy__content">
      ...
      <section>
        ...
        <p>
          Elite Platinum Multiservises ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
        </p>
      </section>
